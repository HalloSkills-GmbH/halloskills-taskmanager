...
export default async function DepartmentBoardGanttPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto max-w-[1680px] px-[var(--pad-x)] pb-14 pt-6">
      <p className="mb-6 max-w-2xl text-sm font-medium leading-relaxed text-app-text">
        Zeitleiste für <strong>{board.name}</strong> — dieselben URL-Parameter wie in der Board-Tabelle.
      </p>
      {error ? (
