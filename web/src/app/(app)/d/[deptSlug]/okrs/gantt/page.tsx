...
export default async function DepartmentOkrsGanttPage({
  params,
}: {
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm font-medium text-app-text">
          Gefiltert auf diese Abteilung; Realtime berücksichtigt dieselbe Einschränkung.
        </p>
      </div>
      {error ? (
      ...
      <OkrFilteredGantt initialAll={all} departmentId={dept.id} />
    </div>
  );
}
